...
<script>
  export default {
    ...
    methods: {
      ...
      init(studentId){
        let _this = this;
        var url = '/student/findStudentById'
        ...
        _this.axios({
          ...
          console.log("res",res);
          _this.number = res.data.value.student_number;
      ...
      updateStudentInfo(){
        ...
        var params = new URLSearchParams();
        params.append('_id', _this.$route.params.studentId);
    ...
    mounted(){
      this.init(this.$route.params.studentId);
    }
  }
</script>
<style>
